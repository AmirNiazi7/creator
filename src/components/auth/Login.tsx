...
export default function Login({ onLogin }: LoginProps) {
  ...
  return (
    <div className="min-h-screen mesh-gradient flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-blue-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }}></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-500/8 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s' }}></div>
      ...
      <div className="bg-zinc-900/80 backdrop-blur-xl border border-zinc-800/50 rounded-2xl shadow-2xl w-full max-w-md p-8 relative z-10 slide-in-up">
        ...
        <div className="relative">
          ...
          <p className="text-center text-gray-400 mb-8">Sign in to your creator dashboard</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-400 to-blue-500 text-white py-3 rounded-lg hover:shadow-lg hover:shadow-blue-400/30 transition-all transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group"
            >
